  ...
  return (
    <section className="py-8 px-4 bg-beige/50">
      <div className="container mx-auto">
        <h2 className="text-2xl font-serif font-bold text-olive mb-6">Gift Registry Dashboard</h2>
        
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          <div className="bg-white p-4 rounded-lg shadow-sm">
            <h3 className="text-sm text-gray-600 mb-1">Total Gifts</h3>
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-olive/5">
                <tr>
                  <th className="px-4 py-3 text-left text-sm font-medium text-olive">Gift</th>
                  <th className="px-4 py-3 text-left text-sm font-medium text-olive">Guest</th>
                  <th className="px-4 py-3 text-left text-sm font-medium text-olive">Status</th>
                  <th className="px-4 py-3 text-left text-sm font-medium text-olive">Method</th>
                  <th className="px-4 py-3 text-right text-sm font-medium text-olive">Price</th>
                </tr>
              </thead>
